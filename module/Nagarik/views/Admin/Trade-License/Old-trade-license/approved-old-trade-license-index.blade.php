                ...
                <div class="widget-header">
                    ...
                    <span class="widget-toolbar">
                        <a href="{{ route('old-trade-license-approval.index') }}">
                                                  {{ __('language.list_of_no_approved_applications') }}
                                                </a>
                    </span>
                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-center">
                                                    <div class="btn-group btn-corner  action-span ">
                                                        ...
                                                        <a href="{{ route("old-trade-license-approval.preview", $old_license->id) }}" role="button" class="btn btn-xs bs-tooltip" style="background-color: #00be59 !important; border: 1px solid #00be59 !important;" title="Full View">
