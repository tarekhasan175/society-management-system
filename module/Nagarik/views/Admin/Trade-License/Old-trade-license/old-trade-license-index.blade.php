            ...
            <div class="widget-box">
                ...
                <div class="widget-header">
                    <h4 class="widget-title">
                        <i class="fa fa-plus-circle"></i>    {{ __('language.old_trade_licence_list') }}
                    </h4>
                    <span class="widget-toolbar">

                    </span>
                    <span class="widget-toolbar">
                        <a href="{{route('old-trade-license-approved-index')}}">
                                                      {{ __('language.list_of_approved_applications') }}
                                                </a>
                    </span>
                </div>
                                        ...
                                        <table class="table table-bordered table-responsive table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-center">
                                                     <span style=" background-color: {{ $old_license->status==0  ? '#FF0000' : '#A069C3' }}; color: {{ $old_license->status==0 ? '#000000' : '#FFFFFF' }}; border-radius: 8px; font-size: 15px;">
                                                ...
                                                <td class="align-center">
                                                    <div class="btn-group btn-corner  action-span ">
                                                        ...
                                                        <a href="{{ route("old-trade-license-approval.show", $old_license->id) }}" role="button" class="btn btn-xs bs-tooltip" style="background-color: #00be59 !important; border: 1px solid #00be59 !important;" title="Full View">
                                                            <i class="fa fa-eye"></i>
                                                        </a>

                                                        <a href="old-trade-license-approved/{{ $old_license->id }}" role="button" class="btn btn-xs bs-tooltip" style="background-color: rgb(92,0,255) !important; border: 1px solid rgb(92,0,255) !important;" title="Edit">
