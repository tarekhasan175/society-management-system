            ...
            <div class="widget-box">
                ...
                <div class="widget-header">
                    <h4 class="widget-title">
                        <i class="fa fa-plus-circle"></i>   {{ __('language.new_tl_apply') }}
                    </h4>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-center">
                                                        <div class="btn-group btn-corner  action-span ">
                                                            ...
                                                            <a href="{{ route("trade-license-approval.show", $old_license->id) }}" role="button" class="btn btn-xs bs-tooltip" style="background-color: #00be59 !important; border: 1px solid #00be59 !important;" title="Full View">
                                                                <i class="fa fa-eye"></i>
                                                            </a>

                                                            <a href="{{ route("trade-license-approval.edit", $old_license->id) }}" role="button" class="btn btn-xs bs-tooltip" style="background-color: #00be59 !important; border: 1px solid #00be59 !important;" title="Full View">
