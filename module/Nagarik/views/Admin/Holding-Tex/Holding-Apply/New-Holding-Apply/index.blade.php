                            ...
                            <td class="text-center">
                                <div class="btn-group btn-corner" style="display: flex">
                                    ...
                                    @if($holdin->h_apply_status == 0)
                                        <form method="POST" action="{{ route('admin-receive-holding-tex-apply.update', $holdin->id) }}">
                                            @csrf
                                            @method('PUT')
                                        ...
                                        <button class="btn btn-sm btn-danger" title="Delete"
                                                onclick="delete_item('{{ route('admin-receive-holding-tex-apply.destroy', $holdin->id) }}')"
                                                type="button">
