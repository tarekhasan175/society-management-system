            ...
            <div class="widget-box">
                ...
                <div class="widget-header">
                    <h4 class="widget-title">
                        <i class="fa fa-plus-circle"></i>  {{__('language.area')}}
                    </h4>
                        ...
                        <div class="row">
                            <div class="col-sm-10 col-sm-offset-1">
                                ...
                                <form action="{{route('region.store')}}" method="post" >
                                    ...
                                    @include('includes.input-label.input-field', ['name' => 'name', 'title' => __('language.area'), 'is_required' => 1])
                                ...
                                <table id="data-table" class="table table-striped table-bordered  mb-2" >
                                    ...
                                    @foreach( $area as $year)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$year->name}}</td>
                                            <td>
                                                <a href="{{ route('region.edit', $year->id) }}" class="btn btn-sm btn-success" title="Edit">
                                                    <i class="fa fa-pencil-square-o"></i>
                                                </a>

                                                <button class="btn btn-sm btn-danger" title="Delete" onclick="delete_item('{{ route('region.destroy', $year->id) }}')" type="button">
