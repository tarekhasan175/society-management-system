...
@section('content')
            ...
            <div class="widget-box">
                <div class="widget-header">
                    <h4 class="widget-title">
                        {{ $oldLicense->business_name }}({{ $oldLicense->businessCategory->type }}), {{ $oldLicense->financialYear->year }} এর নতুন ট্রেড লাইসেন্সের আবেদন সম্পাদনা
                    </h4>
    ...
    <form action="{{ route('new-trade-license.update', $oldLicense->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
