<script>
    ...
    function licencefee() {
        let fyear = document.getElementById('fyear').value
        let btype = document.getElementById('btype').value
        let url = "/nagarik/financial-year-licence-fee";
        let data =
            {
                Fyear: fyear,
                Btype: btype
        ...
        axios.post(url, data).then(
            function (response) {
                ...
                document.getElementById('l_fee').value = response.data.l_fee
    ...
    const business_land_image = document.getElementById('business_land_image');
    const business_land_image_preview = document.getElementById('business_land_image_preview');

    business_land_image.addEventListener('change', function() {
        ...
        if (file) {
            ...
            reader.onload = function(e) {
                business_land_image_preview.src = e.target.result;
                business_land_image_preview.style.display = 'block';
            };

            reader.readAsDataURL(file);
        } else {
            business_land_image_preview.src = '#';
            business_land_image_preview.style.display = 'none';
        }
    });
