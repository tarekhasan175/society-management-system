...
@section('content')
    ...
    <form action="{{ route('old-trade-license.store') }}" method="post" enctype="multipart/form-data">
        @csrf
            ...
            <div class="row form-page">
                ...
                <div class="col-sm-12">
                    <div class="widget-box">
                        ...
                        <div class="widget-header">
                            <h4 class="widget-title">
                                <i class="fa fa-plus-circle"></i> {{ __('language.business_info_old') }}
                                ...
                                <div class="row" style="padding: 10px">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group" id=" ">
                                            <label for="middle-name" class="control-label col-md-4 col-sm-4 col-xs-12">
                                                <span id=" "> {{ __('language.issue_lc_no_old') }}:</span>
                                                <span class="required" style="color: red;">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" name="old_issue_license_no" class="form-control col-md-6 col-xs-12" required/>
                                            </div>
                                        </div>
                                        <br>
                                        <br>
                                        ...
                                        <div class="form-group" id=" ">
                                            <label for="middle-name" class="control-label col-md-4 col-sm-4 col-xs-12">
                                                <span id=" ">  {{ __('language.issue_lc_date_old') }}:</span>
                                                <span class="required" style="color: red;">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" name="old_issue_license_date" class="form-control col-md-6 col-xs-12"
                                                       style="font-family: Georgia, 'Times New Roman', Times, serif;" required/>
                                            </div>
                                        </div>
                                        <br>
                                        <br>
                                        ...
                                        <div class="form-group" id=" ">
                                            <label for="middle-name" class="control-label col-md-4 col-sm-4 col-xs-12">
                                                <span id=" "> {{ __('language.Effective_date_of_renewal') }}: </span>
                                                <span class="required" style="color: red;">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
