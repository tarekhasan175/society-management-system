...
@section('content')
    ...
    <form action="{{route('holding-taxApply.update' , $HoldingData->id)}}" method="post" enctype="multipart/form-data">
        @csrf
        @method('put')
                                        ...
                                        <div class="x_content">
                                            ...
                                            <div id="demo-form2" data-parsley-validate
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input name="h_occupant" type="text" id=""
                                                               ...
                                                               required="required" value="{{$HoldingData->h_occupant}}"/>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input name="h_occupation" type="text" id=""
                                                               class="form-control col-md-7 col-xs-12"
                                                               required="required" value="  {{$HoldingData->h_occupation}}"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group" style=" ">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select name="h_depent_r" id="" class="form-control">
                                                            <option value=" "> {{ __('language.select') }}</option>
                                                            <option value="Husband" {{$HoldingData->h_depent_r == 'Husband' ? 'selected' : ''}}>স্বামী</option>
                                                            <option value="Wife" {{$HoldingData->h_depent_r == 'Wife' ? 'selected' : ''}}>স্ত্রী</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    </label> {{$HoldingData->h_gender}}
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select name="h_gender" id="" class="form-control">
                                                            <option value=" ">{{ __('language.select') }}</option>

                                                            <option value="M" {{$HoldingData->h_depent_r == 'M' ? 'selected' : ''}}>পুরুষ</option>
                                                            <option value="F" {{$HoldingData->h_depent_r == 'F' ? 'selected' : ''}}>মহিলা</option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                                        <input name="h_xt_phone" type="text" id=""
                                                               class="form-control col-md-7 col-xs-12" value=" {{$HoldingData->h_xt_phone}}"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input name="h_xt_mail" type="text" id=""
                                                               class="form-control col-md-7 col-xs-12"
                                                               style="font-family: 'Times New Roman', Georgia, Serif;" value="    {{$HoldingData->h_xt_mail}}"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input name="h_applydate" type="date" id="datePicker" value="  {{$HoldingData->h_applydate}}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <textarea name="h_address" rows="2" cols="20" id=""
                                                                  class="form-control col-md-7 col-xs-12"> {!! $HoldingData->h_address !!}</textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input name="h_xt_nid" type="text" id="" value="{{$HoldingData->h_xt_nid}} "
                                                               class="form-control col-md-7 col-xs-12"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input name="h_tin" type="text" id=""
                                                               class="form-control col-md-7 col-xs-12" value="  {{$HoldingData->h_tin}}"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <textarea name="h_description" rows="2" cols="20" id=""
                                                                  class="form-control col-md-7 col-xs-12">{!!   $HoldingData->h_description !!}</textarea>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="x_content">
                                            ...
                                            <div id="demo-form2" data-parsley-validate
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select name="nagorik_sector_id" id="section"
                                                            ...
                                                            @foreach($sectorAdd as $type)
                                                                <option style="display: none"
                                                                        value="{{$type->id}}"  {{ $type->id == $HoldingData->nagorik_sector_id ? 'selected' : '' }}>{{$type->name}}</option>
                                                            @endforeach
                                                        </select>
                                                        <input type="hidden" name="" id=""/>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select name="nagorik_block_id" id="block"
                                                            ...
                                                            @foreach($bkockAdd as $type)
                                                                <option style="display: none"
                                                                        value="{{$type->id}}" {{ $type->id == $HoldingData->nagorik_block_id ? 'selected' : '' }}>{{$type->name}}</option>
                                                            @endforeach
                                                        </select>
                                                        <input type="hidden" name="" id=""/>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select name="nagorik_road_id" id="road" class="form-control"
                                                            ...
                                                            @foreach($roadAdd as $type)
                                                                <option style="display: none"
                                                                        value="{{$type->id}}" {{ $type->id == $HoldingData->nagorik_road_id ? 'selected' : '' }}>{{$type->name}}</option>
                                                            @endforeach
                                                        </select>
                                                        <input type="hidden" name="" id=""/>
                                                    </div>
                                                ...
                                                <div class="form-group" style=" ">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input name="holding_number" type="text" value="  {{$HoldingData->holding_number}}" id=""
                                                               class="form-control col-md-7 col-xs-12"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group" style=" ">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input name="h_land_wide" type="text" value="  {{$HoldingData->h_land_wide}}" id=""
                                                               class="form-control col-md-7 col-xs-12"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <select name="h_land_use_type" id=" " class="form-control"
                                                                style="font-family: sutonnyMJ;">
                                                            <option value="">--{{ __('language.select') }} --</option>
                                                            @foreach($NagorikLandType as $type)
                                                                <option
                                                                        value="{{$type->id}}" {{ $type->id == $HoldingData->h_land_use_type ? 'selected' : '' }}>{{$type->type}}</option>
                                                            @endforeach
                                                        </select>
{{--                                                        <select name="h_land_use_type" id="" class="form-control">--}}
{{--                                                            <option value="vacant"  {{$HoldingData->h_land_use_type  == 'vacant' ? 'selected' : ''}}>খালি</option>--}}
{{--                                                            <option value="underCon" {{$HoldingData->h_depent_r == 'underCon' ? 'selected' : ''}}>নির্মাণাধীন</option>--}}
{{--                                                            <option value="other" {{$HoldingData->h_depent_r == 'other' ? 'selected' : ''}}>অন্যান্য</option>--}}
{{--                                                        </select>--}}
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input name="h_land_square" type="text" value=" {{$HoldingData->h_land_square}}" id=""
                                                               class="form-control col-md-7 col-xs-12" />
                                                    </div>
                                                </div>
                                        ...
                                        <div class="x_content">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3 col-sm-4 col-xs-12">
                                                    <input name="h_checkbox1_input" type="text" id="" value=" {{$HoldingData->h_checkbox1_input}}"
                                                           class="form-control"/>
                                                </div>
                                                ...
                                                <div class="col-md-4 col-sm-5 col-xs-12">
                                                    <textarea name="h_checkbox1_comment" rows="2" cols="20" id=""
                                                              class="form-control col-md-7 col-xs-12"
                                                              placeholder="&lt;&lt;মন্তব্য>>">{!! $HoldingData->h_checkbox1_comment !!}</textarea>
                                                </div>

                                                <div class="col-md-2 col-sm-5 col-xs-12">
                                                    <label class="file-upload">
                                                        <span><strong>{{ __('language.upload') }}</strong></span>
                                                        <input type="file" multiple="multiple" name="h_checkbox1_upload" value=" "
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3 col-sm-4 col-xs-12">
                                                    <input name="h_checkbox2_input" type="text" id=" " value="{{$HoldingData->h_checkbox2_input}}"
                                                           class="form-control"/>
                                                </div>
                                                <div class="col-md-4 col-sm-5 col-xs-12">
                                                    <textarea name="h_checkbox2_comment" rows="2" cols="20" id=" "
                                                              class="form-control col-md-7 col-xs-12">{!!  $HoldingData->h_checkbox2_comment !!}</textarea>
                                                </div>
                                                <div class="col-md-2 col-sm-5 col-xs-12">
                                                    <label class="file-upload">
                                                        <span><strong>{{ __('language.upload') }}</strong></span>
                                                        <input type="file" multiple="multiple" name="h_checkbox2_upload"
                                                               id=" " style="height: 30px ; width: 150px"/>
                                                    </label>
                                                    <span id="sp9"></span>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3 col-sm-4 col-xs-12">
                                                    <input name="h_checkbox3_input" type="text" id=" " value="{{$HoldingData->h_checkbox3_input}}"
                                                           class="form-control"/>
                                                </div>
                                                <div class="col-md-4 col-sm-5 col-xs-12">
                                                    <textarea name="h_checkbox3_comment" rows="2" cols="20" id=" "
                                                              class="form-control col-md-7 col-xs-12">{!! $HoldingData->h_checkbox3_comment !!}</textarea>
                                                </div>
                                                <div class="col-md-2 col-sm-5 col-xs-12">
                                                    <label class="file-upload">
                                                        <span><strong>{{ __('language.upload') }}</strong></span>
                                                        <input type="file" multiple="multiple" name="h_checkbox3_upload" value=""
                                                               id=" " style="height: 30px ; width: 150px"/>
                                                    </label>
                                                    <span id="sp10"></span>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3 col-sm-4 col-xs-12">
                                                    <input name="h_checkbox4_input" type="text" id=" " value="{{$HoldingData->h_checkbox4_input}}"
                                                           class="form-control"/>
                                                </div>
                                                <div class="col-md-4 col-sm-5 col-xs-12">
                                                    <textarea name="h_checkbox4_comment" rows="2" cols="20" id=" "
                                                              class="form-control col-md-7 col-xs-12">{!! $HoldingData->h_checkbox4_comment !!}</textarea>
                                                </div>
                                                <div class="col-md-2 col-sm-5 col-xs-12">
                                                    <label class="file-upload">
                                                        <span><strong>{{ __('language.upload') }}</strong></span>
                                                        <input type="file" multiple="multiple" name="h_checkbox4_upload"
                                                               id=" " style="height: 30px ; width: 150px"/>
                                                    </label>
                                                    <span id="sp11"></span>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-3 col-sm-4 col-xs-12">
                                                    <input name="h_checkbox5_input" type="text" id=" " value=" {{$HoldingData->h_checkbox5_input}}"
                                                           class="form-control"/>
                                                </div>
                                                <div class="col-md-4 col-sm-5 col-xs-12">
                                                <textarea name="h_checkbox5_comment" rows="2" cols="20" id=" "
                                                          class="form-control col-md-7 col-xs-12">{!! $HoldingData->h_checkbox5_comment !!}</textarea>
                                                </div>
                                                <div class="col-md-2 col-sm-5 col-xs-12">
                                                    <label class="file-upload">
                                                        <span><strong>{{ __('language.upload') }}</strong></span>
                                                        <input type="file" multiple="multiple" name="h_checkbox5_upload"
                                                               id=" " style="height: 30px ; width: 150px"/>
                                                    </label>
                                                    <span id="sp12"></span>
                                                </div>
