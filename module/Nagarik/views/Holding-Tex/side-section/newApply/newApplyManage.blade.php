...
@section('content')
    ...
    <div class="page-header">
        ...
        <a class="btn btn-xs btn-info" href="{{route('holding-tax.index')}}" style="float: right; margin: 0 2px;"> <i
                class="fa fa-plus"></i>  {{ __('language.add_new_button') }}</a>
...
{{--                            <th style="align-items: center">{{ \Carbon\Carbon::parse( $holdin->created_at)->diffForHumans() }}</th>--}}
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-corner">
                                    ...
                                    <a href="{{ route('holding-taxApply.show', $holdin->id) }}"
