...
@section('content')
    ...
    <div class="page-header">
        ...
        <a class="btn btn-xs btn-info" href="{{route('holding-taxApply.index')}}" style="float: right; margin: 0 2px;">
            <i class="fa fa-plus"></i> {{ __('language.go_back') }}</a>
        ...
        <div class="col-xs-12">
            ...
            <div class="align-center bolder">
                ...
                <div class="btn-group btn-corner">
                    ...
                    <a href="{{route('holding-taxApply.index')}}" class="btn btn-sm btn-info" title="Edit">
