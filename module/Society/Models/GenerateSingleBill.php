...
class GenerateSingleBill extends \App\Model
{
          protected $table = 'generate_single_bills';
          ...
          public  function singleBillDetails()
          {
                    return $this->hasMany(GenerateSingleBillDetails::class, 'main_id', 'id');
          }
}
