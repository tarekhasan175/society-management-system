...
class CreateGenerateSingleBillDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('generate_single_bill_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('generate_single_bill_details');
    }
}
