...
class CreateTempGenerateSingleBillsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('temp_generate_single_bills', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('temp_generate_single_bills');
    }
}
