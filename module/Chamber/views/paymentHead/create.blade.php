...
@section('content')
    ...
    <form action="{{route('paymentheads.store')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
        @csrf
            @if($errors->any())
                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-md-6 col-6 col-xs-6">
                            <h4 class="widget-title">Add Payment Head Information</h4>
                        </div>
                ...
                <div class="row" style="margin-top: 15px;">
                    <div class="col-md-6 col-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="PaymentHeadName" id="form-field-2" placeholder="Name"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" id="is-old-checkbox" name="IsMandatory" value="1" >
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" id="is-old-checkbox" name="IsNew" value="1" >
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <textarea name="PaymentHeadDescription" id="form-field-2" class="col-xs-11 col-sm-11 col-md-11" placeholder="PaymentHeadDescription"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" id="is-old-checkbox" name="IsActive" value="1" >
                                    </label>
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" id="is-old-checkbox" name="IsOld" value="1" >
                                    </label>
                                </div>
                            </div>
                        </div>
