...
@section('content')
    ...
    <form action="{{ route('companySetting.store') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
        @csrf
                ...
                <div class="row" style="margin-top: 15px;">
                    <div class="col-md-6 col-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="name" id="form-field-1" placeholder="Company Name"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="address" id="form-field-1" placeholder="Company Address"
                                    class="col-xs-11 col-sm-11 col-md-11">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="phone" id="form-field-1" placeholder="Phone Number"
                                    class="col-xs-11 col-sm-11 col-md-11">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="mobile" id="form-field-1" placeholder="Mobile Number"
                                    class="col-xs-11 col-sm-11 col-md-11">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="web" id="form-field-1" placeholder="domain.com"
                                    class="col-xs-11 col-sm-11 col-md-11">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="email" name="email" id="form-field-1" placeholder="name@domain.com"
                                    class="col-xs-11 col-sm-11 col-md-11">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="shortName" id="form-field-1" placeholder="Short Name"
                                    class="col-xs-11 col-sm-11 col-md-11">
                            </div>
                        </div>
                    </div>
