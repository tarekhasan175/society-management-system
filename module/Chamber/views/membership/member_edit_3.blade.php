...
@section('content')
    ...
    <form action="{{ route('membership.member_update_3', ['id' => $memberShip]) }}" method="POST" class="form-horizontal"
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="proposedMemberName1" id="form-field-1"
                                    value="{{$memberShip->proposedMemberName1}}" class="col-xs-11 col-sm-11 col-md-11">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                value="{{$memberShip->proposedCompanyName1}}" class="col-xs-11 col-sm-11 col-md-11">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea class="col-xs-11 col-sm-11 col-md-11" name="proposedAddress1" id="form-field-9" maxlength="50"
                                    >{{$memberShip->proposedAddress1}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                value="{{$memberShip->proposedMembershipNo1}}" class="col-xs-11 col-sm-11 col-md-11">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="number" name="addedBy" id="form-field-1" value="{{$memberShip->addedBy}}" 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="date" name="addedDate" id="form-field-1" 
                                value="{{ \Carbon\Carbon::parse($memberShip->addedDate)->format('Y-m-d') }}" 
                                class="col-xs-11 col-sm-11 col-md-11">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="proposedMemberName2" id="form-field-1"
                                    value="{{$memberShip->proposedMemberName2}}" class="col-xs-11 col-sm-11 col-md-11">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                value="{{$memberShip->proposedCompanyName2}}" class="col-xs-11 col-sm-11 col-md-11">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea class="col-xs-11 col-sm-11 col-md-11" name="proposedAddress2" id="form-field-9" maxlength="50"
                                    >{{$memberShip->proposedAddress2}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                value="{{$memberShip->proposedMembershipNo2}}" class="col-xs-11 col-sm-11 col-md-11">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                value="{{$memberShip->lastEntryBy}}" class="col-xs-11 col-sm-11 col-md-11">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="date" name="lastEntryDate" id="form-field-1" 
                                value="{{ \Carbon\Carbon::parse($memberShip->lastEntryDate)->format('Y-m-d') }}" 
                                class="col-xs-11 col-sm-11 col-md-11">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select name="session" class="col-xs-11 col-sm-11 col-md-11">
                                    <option value="{{$memberShip->session}}">
                                    {{$memberShip->session}}
                                    </option>
