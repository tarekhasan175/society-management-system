...
<form action="{{ route('membership.member_store_4', ['id' => $latestMemberId]) }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
    @csrf
                ...
                <div class="row" style="margin-top: 15px;">
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="ownerNationalIDImage">Owner NID </label>
                            <div class="col-sm-4">
                                <label class="ace-file-input ace-file-multiple">
                                    <input type="file"name="ownerNationalIDImage"
                                    id="iownerNationalIDImage"
                            ...
                            <div id="image-preview" class="col-sm-4">
                                <label class="ace-file-input ace-file-multiple">
                                    <span class="ace-file-container" data-title=" Preview">
                                        <span class="ace-file-name" data-title="No File ..."><i
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Representative NID </label>
                            <div class="col-sm-4">
                                <label class="ace-file-input ace-file-multiple">
                                    <input multiple="" type="file"
                                    name="representativeNationalIDImage"
                                    id="id-input-file-3"
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Trade Lisence Image </label>
                            <div class="col-sm-4">
                                <label class="ace-file-input ace-file-multiple">
                                    <input multiple="" type="file"
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Tin Certificate Image </label>
                            <div class="col-sm-4">
                                <label class="ace-file-input ace-file-multiple">
                                    <input multiple="" type="file"
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Representative Image </label>
                            <div class="col-sm-4">
                                <label class="ace-file-input ace-file-multiple">
                                    <input multiple="" type="file"
