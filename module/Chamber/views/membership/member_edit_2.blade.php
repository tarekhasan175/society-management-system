...
@section('content')
    ...
    <form action="{{ route('membership.member_update_2', ['id' => $memberShip]) }}" method="POST" class="form-horizontal"
                    ...
                    <div class="col-md-6 col-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="isOwnMember" id="isOwnMember" value="1"
                                    {{ $memberShip->isOwnMember == 1 ? 'checked' : '' }}>
                            </div>
                        </div>
                        ...
                        <div class="form-group" id="ownMemberFields">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="ownerName" id="form-field-1"
                                        value="{{ $memberShip->ownerName }}" class="col-xs-11 col-sm-11 col-md-11">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="ownerNationalIDNo" id="form-field-1"
                                        value="{{ $memberShip->ownerNationalIDNo }}" class="col-xs-11 col-sm-11 col-md-11">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="ownerDesignation" id="form-field-1"
                                        value="{{ $memberShip->ownerDesignation }}" class="col-xs-11 col-sm-11 col-md-11">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="ownerContactNo" id="form-field-1"
                                        value="{{ $memberShip->ownerContactNo }}" class="col-xs-11 col-sm-11 col-md-11">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="ownerFatherName" id="form-field-1"
                                        value="{{ $memberShip->ownerFatherName }}" class="col-xs-11 col-sm-11 col-md-11">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-9">
                                <div class="col-sm-9">
                                    <input type="checkbox" name="isRepMember" id="isRepMember" value="1"
                                        {{ $memberShip->isRepMember == 1 ? 'checked' : '' }}>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="representativeName" id="form-field-1"
                                        value="{{ $memberShip->representativeName }}" class="col-xs-11 col-sm-11 col-md-11">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="representativeDesignation" id="form-field-1"
                                        value="{{ $memberShip->representativeDesignation }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="representativeFatherName" id="form-field-1"
                                        value="{{ $memberShip->representativeFatherName }}"
                                        class="col-xs-11 col-sm-11 col-md-11">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="representativeNationalIDNo" id="form-field-1"
                                        value="{{ $memberShip->representativeNationalIDNo }}"
                                        class="col-xs-11 col-sm-11 col-md-11">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="representativeContactNo" id="form-field-1"
                                        value="{{ $memberShip->representativeContactNo }}"
                                        class="col-xs-11 col-sm-11 col-md-11">
                                </div>
                            </div>
                        </div>
