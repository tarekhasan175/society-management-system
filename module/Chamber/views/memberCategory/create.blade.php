...
@section('content')
    ...
    <form action="{{ route('memberCategory.store') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="memberCategoryName" id="form-field-1"
                                    placeholder="Category Name" class="col-xs-11 col-sm-11 col-md-11">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($memberCategories as $category)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('memberCategory.edit', $category->id) }}"
                                            style="display: inline-block; margin-right: 10px;">
                                            <i class="fa fa-edit"></i>
                                        </a>

                                        <form id="delete-form-{{ $category->id }}"
                                            action="{{ route('memberCategory.destroy', $category->id) }}" method="POST"
