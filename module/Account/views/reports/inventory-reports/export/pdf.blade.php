...
{{--        @endif--}}
    ...
    <div class="" style="width: 100%">
       <div style="text-align: center">
        ...
        <div style="text-align: center">
            <p  class="text-center" style="font-size:20px"><strong>@if(isset($selected_item)) {{ "'".$selected_item->name."' -" }} @endif Stock Details</strong></p>
...
<hr class="d-print"  >
      ...
      <p style="padding: 1px ; margin: 1px">Brand :&nbsp;&nbsp; {{$selected_item->brand->name ?? '' }} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Unit:&nbsp;&nbsp; {{$selected_item->unit->name  ?? ''}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Model:&nbsp;&nbsp;{{$selected_item->model->name ?? ''}}</p>
      @endif
