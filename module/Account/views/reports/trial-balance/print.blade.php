...
{{--                <a href="{{ route('report.transaction-ledger') }}" class="btn btn-danger btn-minier"><i--}}
                <a href="{{ route('report.trial-balance') }}" class="btn btn-danger btn-minier"><i
    ...
    <!-- PRINT CONTENT -->
        <div class="col-sm-12" style="width:100% !important" id="print">
            ...
            <h5 style="line-height: 0; text-align: center !important; background:red !important; margin-top: 30px !important; font-style: italic">
               <strong>From:</strong> {{fdate(request('from'))}} <strong>To:</strong> {{fdate(request('to'))}}

            </h5>

            <table  class="table table-bordered table-striped" border="1" cellpadding="5" style="width: 100% !important;  margin-bottom: 20px">
                <thead>
