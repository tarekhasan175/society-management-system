...
{{--                                        @dd($po)--}}
                                        <select   name="po_number" id="form_field" class="chosen-select-100-percent" data-placeholder="- Select PO Number -">
                                            <option></option>
                                            @foreach($po as $id => $name)
                                                <option value="{{ $id }}" {{ old('customer_id') == $id ? 'selected' : '' }}>{{ $name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5 pull-right">
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-12 col-sm-8 @error('cost') has-error @enderror">
                                                    <input type="text" id="vat" name="vat" autocomplete="off" value="0" class="form-control vat text-right" oninput="calculateDiscount()">
                                                    @error('cost')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function() {
            $(".itemTotal, .discount, .vat").on("input", calculateDiscount);
        ...
        function calculateDiscount()
        {
            ...
            let vat                 = parseFloat(document.querySelector(".vat").value) || 0;
            let discountedTotal     = Number(itemTotal) - Number(discount)
            let vatAmount           = (Number(itemTotal) * Number(vat)) / 100;
            let totalAmount         = discountedTotal + vatAmount;
