...
@section('page-header')
    <i class="fa fa-info-circle"></i> Account Subsidiaries
@stop
@push('style')
                        ...
                        <div class="pull-right tableTools-container" style="margin: 0 !important">
                            <div class="dt-buttons btn-overlap btn-group">
                                ...
                                @if ((hasPermission("account-subsidiaries.create", $slugs)))
                                    <a href="{{route('account-subsidiaries.create')}}" class="dt-button btn btn-white btn-info btn-bold" title="Create New" data-toggle="tooltip" tabindex="0" aria-controls="dynamic-table">
                                        <span>
