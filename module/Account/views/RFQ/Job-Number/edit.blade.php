            ...
            <div class="widget-box widget-color-white ui-sortable-handle clearfix" id="widget-box-7">
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        <form id="submitTo" action="{{route('rfq-job-number.update',$RfNumber->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="row">
                                <!-- Customer -->
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select required name="client_company_id" id="company_id" onchange="company()" class="width-100" style="height: 45px" data-placeholder="- Select Company -">
                                            ...
                                            @foreach($companies as  $name)
                                                <option value="{{ $name->id}}" {{$RfNumber->client_company_id == $name->id ? 'selected' : '' }} >{{ $name->name }}</option>
                                    ...
                                    <div class="input-group  ">
                                        ...
                                        <select required name="rfq_customers_id" id="rfq_customer_id" class="width-100"  data-placeholder="- Select Customer -" style="height: 45px!important;" >
                                            ...
                                            @foreach($customers as   $name)
                                                <option value="{{ $name->id }}" {{$RfNumber->rfq_customers_id == $name->id ? 'selected' : '' }}>{{ $name->customer->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select required name="po_accounts_id" id="form_field" class="width-100"  data-placeholder="- Select Customer -" style="height: 45px!important;" >
                                            ...
                                            @foreach($product_orders as   $number)
                                                <option value="{{ $number->id }}"  {{$RfNumber->po_accounts_id == $number->id ? 'selected' : '' }}  >{{ $number->invoice }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class=" "   >
                                ...
                                <div class="container mt-5 mb-4">
                                    <div class="row form-container">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input type="hidden" id="product_id"    readonly>
                                ...
                                <table id="table" class="form-container">
                                    ...
                                    @foreach($RfNumber->details as $RfNumbers)
                                        <tr>
                                            <td>
                                                <input type="text" name="item[]" value="{{$RfNumbers->item}}" readonly>
                                                <input type="hidden" name="product_id[]" value="{{$RfNumbers->product_id}}"   readonly>
                                            </td>
                                            <td><input type="text" name="description[]" value="{{$RfNumbers->description}}" readonly></td>
                                            <td><input type="text" name="worker_name[]" value="{{$RfNumbers->worker_name}}" readonly></td>
                                            <td><input type="text" name="quantity[]" value="{{$RfNumbers->quantity}}" readonly></td>
                                            <td><input type="text" name="price[]" value="{{$RfNumbers->price}}" readonly></td>
                                            <td><input type="text" name="amount[]" value="{{$RfNumbers->quantity *  $RfNumbers->price}}" readonly></td>
