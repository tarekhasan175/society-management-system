...
@section('page-header')
    <i class="fa fa-info-circle"></i> Job Number List
@stop
        ...
        <div class="col-sm-12">
            ...
            <div class="widget-box widget-color-white ui-sortable-handle clearfix" id="widget-box-7">
                ...
                <div class="widget-header widget-header-small">
                    ...
                    <div class="widget-toolbar">
                        <a href="{{ route('rfq-job-number.create') }}" ><i class="fa fa-plus"></i> Create</a>
                    </div>
                    {{--                    @endif--}}
                </div>
                ...
                <div class="row px-3 pb-2" style="width: 100%; margin: 0 !important;" >
                    <form action="{{ route('rfq-job-number.index') }}" method="get">
                        <div class="row">
                        ...
                        <div class="col-sm-12">
                            <table class="table table-bordered table-striped">
                                ...
                                <tr class="table-header-bg">
                                    ...
                                    <th class="pl-3" style="color: white !important;" width="20%">PO No</th>
                                ...
                                @forelse($quotation as $item)
                                    <tr>
                                        ...
                                        <td class="pl-3">{{ $item->poId->invoice }}</td>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group btn-corner">
                                                ...
                                                <a href="{{ route('rfq-job-number.show', $item->id) }}" target="_blank" class="btn btn-success btn-xs" title="View Details"><i class="fa fa-eye"></i></a>
                                                <a href="{{ route('rfq-job-number.edit', $item->id) }}" target="" class="btn btn-purple btn-xs" title="View Details"><i class="fa fa-edit"></i></a>
...
{{--                                                @if(hasPermission("quotations.delete", $slugs))--}}
                                                    <button type="button" onclick="delete_item('{{ route('rfq-job-number.destroy', $item->id) }}')" class="btn btn-danger btn-xs" title="Delete"><i class="fa fa-trash"></i></button>
{{--                                                @endif--}}
                                            </div>
                                        </td>
                                    </tr>
