    ...
    <div class="row mb-3">
        <div class="column-a" style="text-align: left">
            ...
            <address>
                ...
                <span>{{ optional($QuotationShow->rfqCustomer)->email }}</span>
            </address>
        </div>
        ...
        <div class="col-sm-12">
            <table class="table table-bordered table-striped">
                ...
                <tr class="table-header-bg">
                    ...
                    <th class="pl-3"   width="30%">Product Name</th>
                    <th class="pl-3"   width="30%">Description</th>
                    <th class="pl-3 text-right" style="  text-align: center" width="10%">Quantity</th>
                    <th class="pl-3 text-right"   width="10%">Price</th>
                ...
                @foreach($QuotationShow->details ?? [] as $details)
                    @php
                        $lineTotal = $details->qty * $details->rate;
                    ...
                    <tr>
                        ...
                        <td class="pl-3">
                            <p>{{ $details->item }}</p>
{{--                            <p class="pull-right">--}}
{{--                                <img src="{{asset(optional($details)->image)}}" style="height:100px; width: 100px" alt="">--}}
{{--                            </p>--}}
                        </td>
                        <td class="pl-3">
                ...
                <tfoot>
                <tr>
                    <th colspan="5"><strong class="pull-right">Sub total </strong></th>
                    <th class="pl-3 text-right">{{$totalAmount }}</th>
                </tr>
                <tr>

                    <th colspan="5"><strong class="pull-right">
    ...
    <div class="row mt-5 mb-5">
        <div class="hidden-print" style="float: right; padding-right: 10px !important;">
            <div class="btn-group btn-group-xs">
                ...
                <a class="btn btn-danger btn-xs" href="{{ route('quotations.index') }}"><i class=" fa fa-backward"></i> Back To List</a>
            </div>
        </div>
    </div>
