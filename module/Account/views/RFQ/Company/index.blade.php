                        ...
                        <div class="pull-right tableTools-container" style="margin: 0 !important">
                            <div class="dt-buttons btn-overlap btn-group">
                                ...
                                @if ((hasPermission("account-categories.create", $slugs)))
                                    <a href="{{route('client-company.create')}}" class="dt-button btn btn-white btn-info btn-bold" title="Create New" data-toggle="tooltip" tabindex="0" aria-controls="dynamic-table">
                                        <span>
                    ...
                    <div class="col-sm-12 px-4">
                        <table id="data-table" class="table table-bordered table-striped">
                            ...
                            <tr class="table-header-bg">
                                ...
                                <th class="pl-3" style="color: white !important;" >Sort Name</th>
                            ...
                            @foreach($company as $item)
                                <tr>
                                    ...
                                    <td class="pl-3">{{ $item->sort_name ?? '' }}</td>
                                    <td class="text-center">
                                        <div class="btn-group btn-corner">
                                            @include('partials._user-log', ['data' => $item])


                                                <a href="{{route('client-company.edit', $item->id)}}" class="btn btn-primary btn-xs"><i class="fa fa-pencil-square"></i></a>



                                                <a href="#" onclick="delete_item('{{ route('client-company.destroy', $item->id) }}')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
