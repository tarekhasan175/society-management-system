    ...
    <div class="row">
        <div class="col-sm-8 col-sm-offset-2">
            ...
            <div class="widget-box widget-color-white ui-sortable-handle clearfix" id="widget-box-7">
                ...
                <!-- INPUTS -->
                <form action="{{ route('client-company.update', $company->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="row" style="width: 100%; margin: 0 0 20px !important;">
                        <div class="col-sm-12 px-4">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input id="name" name="name" type="text" required class="form-control input-sm" placeholder="Name" value="{{ $company->name }}">
                                </div>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 control-label" for="name">
                                    <b>Short Name <sup class="text-danger">*</sup></b>
                                </label>

                                <div class="col-sm-9">
                                    <input id="name" name="sort_name" type="text" required class="form-control input-sm" placeholder="Name" value="{{ $company->sort_name }}">
                                </div>
