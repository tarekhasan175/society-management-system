                        ...
                        <div class="pull-right tableTools-container" style="margin: 0 !important">
                            <div class="dt-buttons btn-overlap btn-group">
                                ...
                                @if ((hasPermission("account-categories.create", $slugs)))
                                    <a href="{{route('categories.create')}}" class="dt-button btn btn-white btn-info btn-bold" title="Create New" data-toggle="tooltip" tabindex="0" aria-controls="dynamic-table">
                                        <span>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group btn-corner">
                                                ...
                                                @if ((hasPermission("account-categories.delete", $slugs)))
                                                    <a href="#" onclick="delete_item('{{ route('categories.destroy', $item->id) }}')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
                                                @endif
                                            </div>
                                        </td>
                                    </tr>
