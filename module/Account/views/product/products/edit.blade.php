                    ...
                    <div class="row" style="width: 100%; margin: 0 0 20px !important;">
                        <div class="col-sm-12 px-4">
                                    ...
                                    <div class="col-sm-9">
                                        <select id="brand_id" name="brand_id" required class="chosen-select-100-percent form-control required"
                                            ...
                                            @foreach($brand as $id => $name)
                                                <option value="{{ $id }}" {{ $id == old('brand_id' , $product->brand_id) ? 'selected' : '' }}>{{ $name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-9">
                                        <select id="model_id" name="model_id" required class="chosen-select-100-percent form-control required"
                                            ...
                                            @foreach($model as $id => $name)
                                                <option value="{{ $id }}" {{ $id == old('model_id', $product->model_id) ? 'selected' : '' }}>{{ $name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                           ...
                           <div class="form-group row">
                               ...
                               <div class="col-sm-9">
                                   <input id="opening_quantity" name="opening_quantity" onkeypress="return event.charCode >= 46 && event.charCode <= 57" type="text" class="form-control input-sm" placeholder="Product Opening Stock" value="{{ old('opening_quantity', $product->opening_quantity) }}" readonly>
                               </div>
                           </div>
