                        ...
                        <div class="pull-right tableTools-container" style="margin: 0 !important">
                            <div class="dt-buttons btn-overlap btn-group">
                                ...
                                @if ((hasPermission("account-units.create", $slugs)))
                                    <a href="{{route('brands.create')}}" class="dt-button btn btn-white btn-info btn-bold" title="Create New" data-toggle="tooltip" tabindex="0" aria-controls="dynamic-table">
                                        <span>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-corner">
                                            ...
                                            @if ((hasPermission("account-units.edit", $slugs)))
                                                <a href="{{route('brands.edit', $item->id)}}" class="btn btn-primary btn-xs"><i class="fa fa-pencil-square"></i></a>
                                            @endif

                                            @if ((hasPermission("account-units.delete", $slugs)))
                                                <a href="#" onclick="delete_item('{{ route('brands.destroy', $item->id) }}')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
                                            @endif
                                        </div>
                                    </td>
                                </tr>
