...
@section('title', 'Unit')
@section('page-header')
    <i class="fa fa-edit"></i> Model Edit
@stop
@push('style')
    ...
    <div class="row">
        <div class="col-sm-8 col-sm-offset-2">
            ...
            <div class="widget-box widget-color-white ui-sortable-handle clearfix" id="widget-box-7">
                ...
                <!-- INPUTS -->
                <form action="{{ route('models.update', $unit->id) }}" method="post">
                    @csrf @method('PUT')
                    ...
                    <div class="row" style="width: 100%; margin: 0 0 20px !important;">
                        <div class="col-sm-12 px-4">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input name="name" type="text" required class="form-control input-sm" placeholder="Name" value="{{ old('name', $unit->name) }}">
                                </div>
                            </div>
